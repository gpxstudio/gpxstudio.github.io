...
L.Control.Elevation=L.Control.extend({
    ...
    _drawDragRectangle:function(){
     ...
     _drawRectangle:function(start,end){
                 ...
                 const pt1 = this._data[Math.floor(start * (this._data.length - 1))];
                 const pt2 = this._data[Math.floor(end * (this._data.length - 1))];
...
function display_cursor_data(d, v, e, s) {
    ...
    distance.innerHTML = d.toFixed(1) + ' km';
    speed.innerHTML = v.toFixed(1) + ' km/h';
    elevation.innerHTML = e.toFixed(0) + ' m';
